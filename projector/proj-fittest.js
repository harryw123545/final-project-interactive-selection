 ...
 */
 ...
 class Fittest {
     ...
     display() {
         ...
         // Map values from the genes array to modify different parameters of the creature
         // Parameters include the numbers in the superformula, size, rotation and noise values
         ...
         function drawShapes(radius) {
             ...
             for (var angle = 0; angle < TWO_PI; angle += increment) {
                 ...
                 // Use sin to interpolate between each colour channel
